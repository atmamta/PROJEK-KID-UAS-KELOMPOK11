...
PRIVATE_KEY_PATH = os.path.join(KEY_DIR, "atma_private_key.pem")
PUBLIC_KEY_PATH  = os.path.join(KEY_DIR, "atma_public_key.pem")
...
# 4. Input pesan dari user
pesan = input("Silakan tulis pesan anda disini: ")

# 5. Buat signature (ECDSA + SHA256)
...
# 7. Simpan pesan & signature ke file
